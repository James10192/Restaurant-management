...
| D-092 | Assumés et non corrigés en T3 : annuler un paiement non espèces qui portait une monnaie rendue retire aussi cette monnaie de l'attendu (si elle a vraiment été rendue, l'écart le montrera) ; une table clôturée avec un impayé ne s'encaisse plus (un recouvrement ultérieur est une décision métier à venir) ; le format 80 mm est déclaré (`size: 80mm 297mm`) mais n'a pas encore été vérifié sur une imprimante thermique et une tablette Android réelles | Chacun demande soit une décision du terrain, soit un matériel qu'on n'a pas encore eu en main | accepté | 2026-09-23 |
